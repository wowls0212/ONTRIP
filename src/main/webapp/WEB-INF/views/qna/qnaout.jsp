...
<div class="box">
  ...
  <div class="pagination">
    <c:if test="${paging.startPage != 1}">
      <a href="qnaout?nowPage=${paging.startPage - 1}&cntPerPage=${paging.cntPerPage}">이전</a>
    </c:if>
    ...
    <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="p">
      <c:choose>
        ...
        <c:otherwise>
          <a href="qnaout?nowPage=${p}&cntPerPage=${paging.cntPerPage}">${p}</a>
        </c:otherwise>
      </c:choose>
    </c:forEach>

    <c:if test="${paging.endPage < paging.lastPage}">
      <a href="qnaout?nowPage=${paging.endPage + 1}&cntPerPage=${paging.cntPerPage}">다음</a>
    </c:if>
  </div>
</div>
</body>
